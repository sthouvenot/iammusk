...
Net worths from the Bloomberg Billionaires Index (June 15, 2026), except Taylor Swift and
LeBron James, who are below the index's cutoff and use Forbes (2026) figures. Working life is
counted in seconds as `(age - 18) x 31,536,000`; income per second is `annual income / 31,536,000`.
...
| LeBron James | $1.4B net worth / 23 working yrs | **$1.93** |
...
- Taylor Swift / LeBron James net worth: [Forbes](https://www.forbes.com/profile/)
